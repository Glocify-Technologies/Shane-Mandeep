...
struct EditPetProfileView: View {
    ...
    @State var isDeleteLinkActive: Bool = false
    var body: some View {
        ZStack {
            backgroundColor
            ...
            VStack {
                NavBarWithBackButton(title: "Edit Pet Profile") {
                ...
                ScrollView {
                    VStack(spacing: dWidth * 16/375) {
                        ...
                        //MARK: - LOCATION
                        HStack {
                            PetEditDropDownList(title: "Age", name: "3 Years", option: "Change", image: "outline_expand_more_black_18pt_1x")
                            PetEditDropDownList(title: "Gender", name: "Male", option: "Change", image: "outline_expand_more_black_18pt_1x")
                        }
                        ...
                        NavigationLink (
                            ...
                            isActive: $isDeleteLinkActive,
                            label: {
                                ButtonCommonBlack(buttonName: "Delete Profile", someAction: {
                                    isDeleteLinkActive.toggle()
                                }, color: "#00C600")
...
struct EditPetProfileView_Previews: PreviewProvider {
    static var previews: some View {
        EditPetProfileView(profileName: "")
    }
}

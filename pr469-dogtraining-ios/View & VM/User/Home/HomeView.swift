            ...
            VStack {
                ...
                ZStack {
                    RoundedRectangle(cornerRadius: dWidth * 26/375)
                        ...
                        .frame(width: dWidth * 348/375, height: dWidth * 64.5/375)
                ...
                List{
                    ForEach(vms.allTrainer ?? [Trainer]()) { trainer in
                        UserCard(image: trainer.users?.avatarUrl ?? "", name: trainer.users?.name ?? "" , detail: trainer.location ?? "" , destination: AnyView(ViewTrainerView(trainerData: trainer)))
                    ...
                    if (vms.trainerListFull == false){
                        ...
                        ProgressView()
                            .onAppear {
                                    ...
                                    vms.getAllTrainers(searchText: vms.searchText, page: vms.currentPage + 1, perPage: vms.perPage) { success in

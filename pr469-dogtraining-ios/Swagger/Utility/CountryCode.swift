...
//
//  Created by Neha Saini on 05/05/22.
//
              ...
              HStack {
                  ...
                  .onTapGesture {
                      ...
                      withAnimation(.spring()) {
                          self.y = +3000
                          vm.selectCountryCode = false
                      }
              }
          }
          .padding([.bottom])
          .frame(width: isShowing ? dWidth-60: 0 , height: isShowing ? 300 : 0,alignment: .center)
//          .position(x: View.frame(.global).midX, y: geo.frame(in: .global).maxY - 150)
//

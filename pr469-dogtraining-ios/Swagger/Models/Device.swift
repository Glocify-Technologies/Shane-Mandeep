...
public struct Device: Codable {
    ...
    public init(_id: String?, userId: String?, deviceId: String?, deviceType: String?, devicePushToken: String?, accessToken: String?, accessTokenExpiresAt: String?, latestIpAddress: String?, createdAt: String?, updatedAt: String?) {
        self._id = _id
        self.userId = userId

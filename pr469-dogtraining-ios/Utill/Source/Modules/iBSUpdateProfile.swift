...
public class iBSUpdateProfile: iBSBase {
    ...
    public func updateProfileInfoNetworkRequest(completion: @escaping iBSCompletionHandlerWithData) {
        ...
        ProfileAPI.profilePutUpdateMyProfile(firstName: "", email: "", accept: "application/json", lastName: "", phone: "", completion: { (response, error) in
            ...
            if error != nil {
                ...
                let payloadDictionary: PayloadDictionary = (payload as? PayloadDictionary) ?? [:]
    ...
    public func updateProfilePictureNetworkRequest(url: URL, completion: @escaping iBSCompletionHandlerWithData) {
        ...
        ProfileAPI.profilePostUpdateMyAvatar(image: url, accept: "application/json", completion: { (response, error) in
